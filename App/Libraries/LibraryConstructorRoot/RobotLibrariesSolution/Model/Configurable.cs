...
namespace Model
{
    public static class Configurable
    {
		...
		public static void Initialize(string parameterJsonPath)
        {
            ...
            {
                throw new Exception("Error inicializando Configurable: " + ex.Message);
			}
		}
        ...
        public static void Update()
        {
			...
			{
				throw new Exception("Error actualizando Configurable desde archivo: " + ex.Message);
			}
        }
        public static void Save()
        {
			...
			{
				throw new Exception("Error guardando Configurable en archivo: " + ex.Message);
			}
		}
        public static void Save(string parameterPathConfig)
        {
			...
			{
				throw new Exception("Error guardando Configurable en archivo especificado: " + ex.Message);
			}
		}
        public static void ChangeSavingPath(string parameterPathConfig)
        {
            ...
            {
                throw new Exception("No se pudo cambiar la ruta de Configurable, puede que sea incorrecta: " + ex.Message);
            }
        }
