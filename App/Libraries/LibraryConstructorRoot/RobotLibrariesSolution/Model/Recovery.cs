...
namespace Model
{
    public static class Recovery
    {
		...
		public static void Initialize(string parameterJsonPath)
        {
            ...
            {
                throw new Exception("Error inicializando Recovery: " + ex.Message);
			}
		}
        ...
        public static void Update()
        {
			...
			{
				throw new Exception("Error actualizando Recovery desde archivo: " + ex.Message);
			}
        }
        public static void Save()
        {
			...
			{
				throw new Exception("Error guardando Recovery en archivo: " + ex.Message);
			}
		}
        public static void Save(string parameterPathConfig)
        {
			...
			{
				throw new Exception("Error guardando Recovery en archivo especificado: " + ex.Message);
			}
		}
        public static void ChangeSavingPath(string parameterPathConfig)
        {
            ...
            {
                throw new Exception("No se pudo cambiar la ruta de Recovery, puede que sea incorrecta: " + ex.Message);
            }
        }
        ...
        #region Properties
		public static String LastRecover 
		{ 
			get	
			{
				return (String)_jsonValues["LastRecover"];
			} 
			
			set 
			{
				_jsonValues["LastRecover"] = value;
			}
		}

		public static String RecoverLapse 
		{ 
			get	
			{
				return (String)_jsonValues["RecoverLapse"];
			} 
			
			set 
			{
				_jsonValues["RecoverLapse"] = value;
			}
		}
		...
		{ 
			get	
			{
				return (String)_jsonValues["General"];
			} 
			
			set 
			{
				_jsonValues["General"] = value;
			}
		}

		public static String ProcessMain 
		{ 
			get	
			{
				return (String)_jsonValues["ProcessMain"];
			} 
			
			set 
			{
				_jsonValues["ProcessMain"] = value;
			}
		}
