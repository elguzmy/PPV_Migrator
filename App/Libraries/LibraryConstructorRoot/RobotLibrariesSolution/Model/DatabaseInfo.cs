...
namespace Model
{
    public static class DatabaseInfo
    {
		...
		public static void Initialize(string parameterJsonPath)
        {
            ...
            {
                throw new Exception("Error inicializando DatabaseInfo: " + ex.Message);
			}
		}
        ...
        public static void Update()
        {
			...
			{
				throw new Exception("Error actualizando DatabaseInfo desde archivo: " + ex.Message);
			}
        }
        public static void Save()
        {
			...
			{
				throw new Exception("Error guardando DatabaseInfo en archivo: " + ex.Message);
			}
		}
        public static void Save(string parameterPathConfig)
        {
			...
			{
				throw new Exception("Error guardando DatabaseInfo en archivo especificado: " + ex.Message);
			}
		}
        public static void ChangeSavingPath(string parameterPathConfig)
        {
            ...
            {
                throw new Exception("No se pudo cambiar la ruta de DatabaseInfo, puede que sea incorrecta: " + ex.Message);
            }
        }
		...
		{ 
			get	
			{
				return (String)_jsonValues["ConnectionString"];
			} 
			
			set 
			{
				_jsonValues["ConnectionString"] = value;
			}
		}
		...
		{ 
			get	
			{
				return (String)_jsonValues["ProviderName"];
			} 
			
			set 
			{
				_jsonValues["ProviderName"] = value;
			}
		}
		...
		{ 
			get	
			{
				return (String)_jsonValues["SPName"];
			} 
			
			set 
			{
				_jsonValues["SPName"] = value;
			}
		}
		...
		{ 
			get	
			{
				return (String)_jsonValues["Error"];
			} 
			
			set 
			{
				_jsonValues["Error"] = value;
			}
		}
		...
		{ 
			get	
			{
				return (Boolean)_jsonValues["HasErrors"];
			} 
			
			set 
			{
				_jsonValues["HasErrors"] = value;
			}
		}
